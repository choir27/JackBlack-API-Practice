...
fetch(drawFour)
  ...
  .then(data=>{
   ...
   localStorage.setItem('oppImages',opponentCards)
   localStorage.setItem('yourImages', yourCards)
...
fetch(drawTwo)
  ...
  convertNumber(yourVal)
  localStorage.setItem('newCard',data.cards[0].images.png)
  getSum()
...
return a+b
  ...
  localStorage.setItem('getYourSum',yourSum)
...
return a+b
  ...
  localStorage.setItem('getTheirSum',yourSum)
